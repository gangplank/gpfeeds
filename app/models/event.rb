class Event
  ...
  def self.pull_events
    url = "https://www.googleapis.com/calendar/v3/calendars/gangplankhq.com_0fgcnbe2jug0b1bi43m5qv86s8%40group.calendar.google.com/events?futureevents=true&timeMin=#{today}&timeMax=#{future}&key=#{ENV['GOOGLE_CAL_KEY']}&singleEvents=true&orderBy=startTime"
